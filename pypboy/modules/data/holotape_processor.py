...
class Module(pypboy.SubModule):
    ...
    def start_audio_queue(self, start_index, files):
        ...
        ``files`` is expected to be absolute paths and is queued starting at
        ``start_index``.
        """
    ...
    def get_data(self):
        ...
        if not os.path.isdir(self.holotape_folder):
            print(f"Holotape directory not found: {self.holotape_folder}")
